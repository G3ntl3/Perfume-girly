...
const data = [
  ...
  },
  {
    ...
    name: " Cocktail",
    about:
      " >The aroma is luxurious, attractive, and intoxicating with its flawlessness and depth. ",
    price: 19000,
  },
  {
    image: {
    ...
    name: "24k perfume",
    about:
      "This luxurious scent is infused with gold flakes that add a touch of glamour and sophistication.",
    price: 7000,
  },
  {
    image: {
    ...
    about:
      "Immerse yourself in the heart of this captivating fragrance, where the blend of top notes ignites your senses with a burst of vibrant citrus.",
    price: 4000,
  },
  {
    image: {
    ...
    name: "Riggs",
    about:
      "Made using the best French fragrances with stunning light and refreshing notes, Riggs Body Spray offers 24-hour protection, keeping you on the move all day and night.",
    price: 4000,
  },
  {
    image: {
    ...
    name: "Wave Body Mist",
    about:
      "Wave® body mist is a fresh, lightweight scent that entices with a mix of dewy tropical fruit. Enter a swell of passionate flowers. ",
    price: 4550,
  },
];
...
const handleAddToCart = (itemName, itemPrice, controlsContainer) => {
  ...
  document
    .getElementById(`minus-btn-${itemName}`)
...
const renderAddButton = (controlsContainer, itemName, itemPrice) => {
  ...
  addButton.classList.add("btn", "cart-btn", "btn-sm", "mt-2"); // Bootstrap button styling
  ...
  <img src="${product.image.thumbnail}"
    ...
    <div class="card-body">
      ...
      <div class="price-add-line">
        <span><b>Price:</b> ₦${product.price.toFixed(
      2
    )}</span>
        <div class="controls-container"></div>
      </div>
      <p class='text-start'><b>About:</b><br><i>${product.about
      }</i></p>
    </div>

    `;

    const controlsContainer = productCard.querySelector(
      ".controls-container"
    );
...
document.getElementById('whatsappOrderBtn').addEventListener('click', function () {
  ...
  let message = "Hello Perfumegirly ! I'd like to order the following:\n\n";
  ...
  const phoneNumber = "2348023855184";
